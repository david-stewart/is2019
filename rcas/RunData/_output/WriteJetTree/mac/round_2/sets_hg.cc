...
void sets_hg(int which_set=0, const char* tag="8up_shift"){
   ...
   pad1->SetFrameBorderMode(0);
    ...
    /* for (int i=0;i<8;++i) { */
        ...
        if (first) {
            ...
            blank->GetYaxis()->SetTitle("S = #frac{1}{N_{trig}} dN^{ch}_{jets-raw}/dp^{ch}_{T,jets-raw}");
            ...
            blank->GetYaxis()->SetTitleOffset(0.93);
   ...
   /* leg[0] = new TLegend(0.7470821,0.3237304,0.9952567,0.3921199,NULL,"brNDC"); */
    ...
    /* leg[7] = new TLegend(0.7470821,0.7778368,0.9952567,0.8462263,NULL,"brNDC"); */
   ...
   pad2->SetFrameBorderMode(0);
    ...
    blank__17->GetXaxis()->SetTitle("p^{ch}_{T,jets-raw}(GeV)");
    ...
    c1->SaveAs(Form("pdf/sets_%s%i.pdf",tag,which_set));
