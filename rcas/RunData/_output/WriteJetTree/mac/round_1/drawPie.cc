...
void drawPie(){
    int colors[8] {924, 960, 996, 1032, 1068, 1104, 1140, kRed};
    /* int colors[8] {924, 960, 996, 1032, 1068, 1104, 1140, kRed}; */
    /* int colors[8] {924, 960, 996, 1032, 1068, kWhite, kWhite, kRed}; */
    int c_16[16];
    double vals[16];
...
/*         /1* if (i==0) { z->Draw("box"); gPad->SetLogz(); } *1/ */
/*         /1* else      z->Draw("box same"); *1/ */
/*     } */
/*     TCanvas *c1 = new TCanvas("c1"); */
/*     c1->SetLogz(); */
/*     stack->Draw("lego4"); */
/*     /1* stack->GetXaxis()->SetRangeUser(1e-5,.6); *1/ */
/*     /1* stack->Draw("lego1"); *1/ */
/*     /1* c1->Update(); *1/ */
/*     return; */
/* } */
...
/*     /1* int col8[8] {924, 960, 996, 1032, 1068, 1104, 1140, 1176}; *1/ */
/*     int c_8[8] {924, 960, 996, 1032, 1068, 1104, 1140, kRed}; */
/*     /1* int black_8[8] {kBlack,kBlack,kBlack,kBlack,kBlack,kBlack,kBlack,kBlack}; *1/ */
...
/*     /1* vector<TH1D*> all_8 = getStripes8(hg2_all,"all",m_8_lo, black_8,sizes); *1/ */
...
/*     //------------------------------------------------- */
/*     /1* if (false) drawStripes2D(ratio, "ratio", c_8); *1/ */
...
/*     vector<int> plots; */
/*     double *bot_edge[8]; */
/*     /1* int     bot_nbins[8]{ 27, 21, 16, 10, 10, 8, 9, 27 }; *1/ */
...
/*     /1* bot_edge[3] = new double[10] {0,1,2,3,4,5,6,9,14,20}; *1/ */
/*     /1* bot_nbins[2] = 9; *1/ */
...
/*         case 1: */
/*         case 4: */
/*             /1* plots = vector<int> {1,2,3,4,5,6,7}; *1/ */
/*             plots = vector<int> {1,2,3,4,7}; */
/*             break; */
/*         case 2: */
/*         case 5: */
/*             /1* plots = vector<int> {0,1,2,3,4,5,6,7}; *1/ */
...
/*             /1* bot_nbins = new int[8]{ 27, 21, 16, 10, 10, 8, 9, 27 }; *1/ */
/*         break; */
/*         /1* /2* case 1: // away side only, up to 9 *2/ *1/ */
/*         /1* /2*     plots = vector<int> { 6, 7 }; *2/ *1/ */
/*         /1* /2*     for (auto i : plots) { *2/ *1/ */
/*         /1* /2*         top_nbins[i] = 9; *2/ *1/ */
/*         /1* /2*         for (int j=0; j<10;++j) top_edge[i][j] = j*1.0; *2/ *1/ */
/*         /1* /2*     } *2/ *1/ */
/*         /1* /2*     bot_nbins[7]=9; *2/ *1/ */
/*         /1* /2* break; *2/ *1/ */
/*         /1* case 2: // away side only, up to 9 *1/ */
/*         /1*     plots = vector<int> { 3,4,5, 6, 7 }; *1/ */
...
/*         /1*     bot_nbins[7] = 9; *1/ */
/*         /1* break; *1/ */
/*         /1* case 3: // away side only, up to 9 *1/ */
/*         /1*     plots = vector<int> { 1,2,3,4,5, 6, 7 }; *1/ */
/*         /1*     for (auto i : plots) { *1/ */
/*         /1*         top_nbins[i] = 9; *1/ */
/*         /1*         for (int j=0; j<10;++j) top_edge[i][j] = j*1.0; *1/ */
...
/*         /1*     bot_nbins[1]=9; *1/ */
/*         /1* break; *1/ */
/*         /1* case 4: // away side only, up to 9 *1/ */
/*         /1*     plots = vector<int> { 0,1,2,3,4,5, 6, 7 }; *1/ */
/*         /1*     for (auto i : plots) { *1/ */
/*         /1*         top_nbins[i] = 9; *1/ */
/*         /1*         for (int j=0; j<10;++j) top_edge[i][j] = j*1.0; *1/ */
...
/*         /1*     bot_nbins[0]=9; *1/ */
/*         /1* break; *1/ */
/*         /1* case 5: // away side only, up to 9 *1/ */
/*         /1*     plots = vector<int> { 4,5, 6, 7 }; *1/ */
/*         /1* break; *1/ */
/*         /1* case 6: // away side only, up to 9 *1/ */
/*         /1*     plots = vector<int> { 0, 3,4,5, 6, 7 }; *1/ */
/*         /1* break; *1/ */
/*         /1* case 7: // away side only, up to 9 *1/ */
/*         /1*     plots = vector<int> {0,1,2,3,4,5,6,7}; *1/ */
/*         /1* break; *1/ */
/*     } */
...
/*     c1->cd(); */
/*     /1* pad2->Draw(); *1/ */
/*    /1* TPad *pad1 = new TPad("pad1", "pad1",0,0.4981685,0.9983498,0.997558); *1/ */
...
/*     /1* Int_t ci;      // for color index setting *1/ */
/*     /1* ci = TColor::GetColor("#352a86"); *1/ */
/*     /1* hi_1__hirebin__18->SetLineColor(ci); *1/ */
/*     /1* ci = TColor::GetColor("#000099"); *1/ */
/*     /1* blank__17->SetLineColor(ci); *1/ */
...
/*     line->SetLineWidth(1); */
/*     line->Draw("same"); */
/*     /1* line = new TLine(0,2.,38,2.); *1/ */
/*     /1* line->SetLineColor(kRed-9); *1/ */
/*     /1* line->SetLineStyle(2); *1/ */
/*     /1* line->SetLineWidth(1); *1/ */
/*     /1* line->Draw("same"); *1/ */
